...
f1 <- ggplot(fecundity_data, aes(x = Genus, y = Fecundity_Value)) +
  ...
  geom_rect(data = shading_data, aes(xmin = xmin - 0.3, xmax = xmax + 0.3, ymin = 0, ymax = 5000, fill = family_molecules),
...
ggsave(filename = "../methods/plots/fecundity_family.pdf", 
       plot = f1, 
...
f2 <- ggplot(colony_data, aes(x = Genus, y = Fecundity_Value)) +
  # Add shaded background rectangles
  geom_rect(data = shading_data, aes(xmin = xmin - 0.3, xmax = xmax + 0.3, ymin = 0, ymax = 2e+06, fill = family_molecules),
            inherit.aes = FALSE, alpha = 0.2) +
  # Add boxplot
  geom_boxplot(aes(fill = family_molecules), alpha = 0.7, outlier.shape = NA) +
  # Add jittered points
...
ggsave(filename = "../methods/plots/colony_fecundity_family.pdf", 
       plot = f2, 
       width = 20, height = 7, units = "in")
```
...
f3<- ggplot(indo_pacific_data, aes(x = Genus, y = Fecundity_Value)) +
  # Add shaded background rectangles
  geom_rect(data = shading_data, aes(xmin = xmin - 0.3, xmax = xmax + 0.3, ymin = 0, ymax = 1e+22, fill = family_molecules),
            inherit.aes = FALSE, alpha = 0.2) +
  # Add boxplot
  geom_boxplot(aes(fill = family_molecules), alpha = 0.7, outlier.shape = NA) +
  # Add jittered points
...
ggsave(filename = "../methods/plots/indopacific_fecundity_family.pdf", 
       plot = f3, 
       width = 20, height = 7, units = "in")
